...
export default function CtaSection() {
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-r from-secondary/20 to-tertiary/20 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Join Ignite Student Association and be part of a community that fosters growth, innovation, and leadership.
          </p>
