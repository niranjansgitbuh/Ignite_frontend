        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8">
              Become part of a vibrant community that fosters growth and innovation
            </p>
          </motion.div>
          ...
          >
            <img src="/placeholder.svg?height=600&width=1200" alt="Join Ignite SA" className="w-full h-auto" />
          </motion.div>
        </div>
      </div>
    </section>
