        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Contact{" "}
              <span className="bg-gradient-to-r from-secondary to-tertiary bg-clip-text text-transparent">Us</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-700 mb-8">
              Get in touch with the Ignite Student Association team
            </p>
          </motion.div>
          ...
          >
            <img src="/placeholder.svg?height=600&width=1200" alt="Contact Ignite SA" className="w-full h-auto" />
          </motion.div>
        </div>
      </div>
    </section>
